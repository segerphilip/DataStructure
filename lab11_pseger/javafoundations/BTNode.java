...
//        if (left == null) {
//            return element + ": (right of " + element + ") " + right + "\n";
//        }
//        if (right == null) {
//            return element + ": (left of " + element + ") " + left + "\n";
//        }
//        if (left == null && right == null) {
//            return "" + element + "\n";
//        }
//        return element + ": (left of " + element + ") " + left + 
//            ", (right of " + element + ") " + right + "\n";
        
        return element + " " + left + " " + right;
    } // Only shows the value of the element, not location 
    // or left-right values specifically ... ordered functions
